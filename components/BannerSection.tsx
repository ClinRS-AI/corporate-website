...
export default function BannerSection() {
  ...
  const heroClassName = "relative z-10 text-center px-6 max-w-2xl";
  ...
  const heroContent = (
    <>
      ...
      <p className="text-slate-300 font-light mb-8 text-base leading-relaxed">
        ClinRS AI empowers health sciences teams using a digital platform to deliver high impact tools, custom software
